...
class DetailViewModelTest {
    ...
    fun getDetailMovie() {
        ...
        val dataMovieEntities = viewModel.getDetailData(movieType, movieId)
        ...
        assertEquals(dataMovie?.backdrop, viewModel.getDetailData(movieType, movieId).value?.backdrop)
        ...
        assertEquals(dataMovie?.releaseDate, viewModel.getDetailData(movieType, movieId).value?.releaseDate)
    }
    ...
    fun getDetailTvShow() {
        ...
        val dataTvShowEntities = viewModel.getDetailData(tvShowType, tvShowId)
        ...
        assertEquals(dataTvShow?.poster, viewModel.getDetailData(tvShowType, tvShowId).value?.poster)
        assertEquals(dataTvShow?.backdrop, viewModel.getDetailData(tvShowType, tvShowId).value?.backdrop)
        assertEquals(dataTvShow?.desc, viewModel.getDetailData(tvShowType, tvShowId).value?.desc)
        assertEquals(dataTvShow?.tagline, viewModel.getDetailData(tvShowType, tvShowId).value?.tagline)
        assertEquals(dataTvShow?.rate, viewModel.getDetailData(tvShowType, tvShowId).value?.rate)
        assertEquals(dataTvShow?.airDate, viewModel.getDetailData(tvShowType, tvShowId).value?.airDate)
    }
}